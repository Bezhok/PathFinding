...
namespace src.EnumMessenger
{
    ...
    {
        public static readonly Dictionary<GameEvent, Delegate> eventTable = new Dictionary<GameEvent, Delegate>();
        public static MessengerMode DEFAULT_MODE = MessengerMode.REQUIRE_LISTENER;

        public static void AddListener(GameEvent eventType, Delegate callback)
        {
            OnListenerAdding(eventType, callback);
            eventTable[eventType] = Delegate.Combine(eventTable[eventType], callback);
        }

        public static void RemoveListener(GameEvent eventType, Delegate handler)
        {
        ...
        public static T[] GetInvocationList<T>(GameEvent eventType)
        {
            Delegate d;
        ...
        public static void OnListenerAdding(GameEvent eventType, Delegate listenerBeingAdded)
        {
        ...
        public static void OnListenerRemoving(GameEvent eventType, Delegate listenerBeingRemoved)
        {
        ...
        public static void OnListenerRemoved(GameEvent eventType)
        {
            if (eventTable[eventType] == null) eventTable.Remove(eventType);
        }

        public static void OnBroadcasting(GameEvent eventType, MessengerMode mode)
        {
        ...
        public static BroadcastException CreateBroadcastSignatureException(GameEvent eventType)
        {
...
// No parameters
    ...
    {
        public static void AddListener(GameEvent eventType, Action handler)
        {
            MessengerInternal.AddListener(eventType, handler);
        }

        public static void AddListener<TReturn>(GameEvent eventType, Func<TReturn> handler)
        {
            MessengerInternal.AddListener(eventType, handler);
        }

        public static void RemoveListener(GameEvent eventType, Action handler)
        {
            MessengerInternal.RemoveListener(eventType, handler);
        }

        public static void RemoveListener<TReturn>(GameEvent eventType, Func<TReturn> handler)
        {
            MessengerInternal.RemoveListener(eventType, handler);
        }
        ...
        public static void Broadcast<TReturn>(GameEvent eventType, Action<TReturn> returnCall)
        {
            Broadcast(eventType, returnCall, MessengerInternal.DEFAULT_MODE);
        }

        public static void Broadcast(GameEvent eventType, MessengerMode mode)
        {
        ...
        public static void Broadcast<TReturn>(GameEvent eventType, Action<TReturn> returnCall, MessengerMode mode)
        {
            MessengerInternal.OnBroadcasting(eventType, mode);
            Func<TReturn>[] invocationList = MessengerInternal.GetInvocationList<Func<TReturn>>(eventType);

            foreach (TReturn result in invocationList.Select(del => del.Invoke())) returnCall.Invoke(result);
        }
    }
...
// One parameter
    ...
    {
        public static void AddListener(GameEvent eventType, Action<T> handler)
        {
            MessengerInternal.AddListener(eventType, handler);
        }

        public static void AddListener<TReturn>(GameEvent eventType, Func<T, TReturn> handler)
        {
            MessengerInternal.AddListener(eventType, handler);
        }

        public static void RemoveListener(GameEvent eventType, Action<T> handler)
        {
            MessengerInternal.RemoveListener(eventType, handler);
        }

        public static void RemoveListener<TReturn>(GameEvent eventType, Func<T, TReturn> handler)
        {
            MessengerInternal.RemoveListener(eventType, handler);
        }

        public static void Broadcast(GameEvent eventType, T arg1)
        {
            Broadcast(eventType, arg1, MessengerInternal.DEFAULT_MODE);
        }

        public static void Broadcast<TReturn>(GameEvent eventType, T arg1, Action<TReturn> returnCall)
        {
            Broadcast(eventType, arg1, returnCall, MessengerInternal.DEFAULT_MODE);
        }

        public static void Broadcast(GameEvent eventType, T arg1, MessengerMode mode)
        {
            MessengerInternal.OnBroadcasting(eventType, mode);
            ...
            MessengerMode mode)
        {
            ...
            foreach (TReturn result in invocationList.Select(del => del.Invoke(arg1))) returnCall.Invoke(result);
        }
    }
...
// Two parameters
    ...
    {
        public static void AddListener(GameEvent eventType, Action<T, U> handler)
        {
            MessengerInternal.AddListener(eventType, handler);
        }

        public static void AddListener<TReturn>(GameEvent eventType, Func<T, U, TReturn> handler)
        {
            MessengerInternal.AddListener(eventType, handler);
        }

        public static void RemoveListener(GameEvent eventType, Action<T, U> handler)
        {
            MessengerInternal.RemoveListener(eventType, handler);
        }

        public static void RemoveListener<TReturn>(GameEvent eventType, Func<T, U, TReturn> handler)
        {
            MessengerInternal.RemoveListener(eventType, handler);
        }

        public static void Broadcast(GameEvent eventType, T arg1, U arg2)
        {
            Broadcast(eventType, arg1, arg2, MessengerInternal.DEFAULT_MODE);
        }

        public static void Broadcast<TReturn>(GameEvent eventType, T arg1, U arg2, Action<TReturn> returnCall)
        {
            Broadcast(eventType, arg1, arg2, returnCall, MessengerInternal.DEFAULT_MODE);
        }

        public static void Broadcast(GameEvent eventType, T arg1, U arg2, MessengerMode mode)
        {
            MessengerInternal.OnBroadcasting(eventType, mode);
            ...
            MessengerMode mode)
        {
            ...
            foreach (TReturn result in invocationList.Select(del => del.Invoke(arg1, arg2))) returnCall.Invoke(result);
        }
    }
...
// Three parameters
    ...
    {
        public static void AddListener(GameEvent eventType, Action<T, U, V> handler)
        {
            MessengerInternal.AddListener(eventType, handler);
        }

        public static void AddListener<TReturn>(GameEvent eventType, Func<T, U, V, TReturn> handler)
        {
            MessengerInternal.AddListener(eventType, handler);
        }

        public static void RemoveListener(GameEvent eventType, Action<T, U, V> handler)
        {
            MessengerInternal.RemoveListener(eventType, handler);
        }

        public static void RemoveListener<TReturn>(GameEvent eventType, Func<T, U, V, TReturn> handler)
        {
            MessengerInternal.RemoveListener(eventType, handler);
        }

        public static void Broadcast(GameEvent eventType, T arg1, U arg2, V arg3)
        {
            Broadcast(eventType, arg1, arg2, arg3, MessengerInternal.DEFAULT_MODE);
        }

        public static void Broadcast<TReturn>(GameEvent eventType, T arg1, U arg2, V arg3, Action<TReturn> returnCall)
        {
            Broadcast(eventType, arg1, arg2, arg3, returnCall, MessengerInternal.DEFAULT_MODE);
        }

        public static void Broadcast(GameEvent eventType, T arg1, U arg2, V arg3, MessengerMode mode)
        {
            MessengerInternal.OnBroadcasting(eventType, mode);
